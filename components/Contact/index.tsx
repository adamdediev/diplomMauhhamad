...
const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
  ...
  const form = e.currentTarget; // сохраняем форму в переменную
  ...
  try {
    ...
    if (data.success) {
      ...
      setStatus("Ошибка отправки: " + (data.error || "Неизвестная ошибка"));
    }
  } catch (error) {
    setStatus("Ошибка отправки: " + (error instanceof Error ? error.message : "Ошибка"));
  }
};
      ...
      <div className="relative mx-auto max-w-c-1390 px-7.5 pt-10 lg:px-15 lg:pt-15 xl:px-20 xl:pt-20">
        ...
        <div className="flex flex-col-reverse flex-wrap gap-8 md:flex-row md:flex-nowrap md:justify-between xl:gap-20">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex flex-wrap gap-4 xl:justify-between ">
                <div className="mb-4 flex md:mb-0">
                  ...
                  >
                    Устанавливая флажок, вы соглашаетесь с условиями и даёте согласие на использование файлов cookie.
                  </label>
                </div>
            ...
            {status && (
              <p
                className={`mt-4 font-medium ${
                  status.includes("Ошибка") ? "text-red-600" : "text-green-600"
                }`}
              >
                {status}
              </p>
          ...
          >
            ...
            <div className="mb-7">
              <h3 className="mb-4 text-metatitle3 font-medium text-black dark:text-white">Адрес</h3>
              <p><a href="mailto:bokri904@mail.ru">bokri904@mail.ru</a></p>
            </div>

            <div>
              <h4 className="mb-4 text-metatitle3 font-medium text-black dark:text-white">Номер телефона</h4>
              <p><a href="tel:+79899045487">+7 989 904 54-87</a></p>
            </div>
          </motion.div>
        </div>
      </div>
